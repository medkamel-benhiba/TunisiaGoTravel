...
import 'package:tunisiagotravel/screens/hotel_details_screen.dart';


class HotelCardDest extends StatelessWidget {
  final Hotel hotel;
            ...
            Positioned(
              ...
              child: Column(
                ...
                children: [
                  // Hotel Name
                  Text(
                    hotel.getName(Localizations.localeOf(context)) ??
                        'Nom non disponible',
                    style: TextStyle(
                  ...
                  if (hotel.address != null)
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            hotel.getAddress(Localizations.localeOf(context))!,
                            style: TextStyle(
                              fontSize: screenWidth < 600 ? 10 : 12,
                              color: Colors.white.withOpacity(0.8),
                            ),
